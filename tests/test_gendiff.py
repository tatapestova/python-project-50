...
FLAT_YML2 = 'tests/fixtures/files/filepath2.yml'
...
def test_generate_stylish_flat_diff():
    ...
    assert generate_diff(FLAT_YML1, FLAT_YML2) == expected_flat_result
...
def test_generate_flat_nested_diff():
    ...
    assert generate_diff(FLAT_YML1, FLAT_YML2, 'plain') == expected_flat_result
...
def test_generate_plain_nested_diff():
    ...
    assert generate_diff(NESTED_YML1, NESTED_YML2, 'plain') == expected_nested_result